<script lang="ts">
  ...
  const X_AXIS_COLOR = '#0b161f'; // c-input
...
<div class="relative rounded-lg bg-c-input border border-c-border/50 p-4 text-sm">
  <p class="text-xs font-semibold uppercase tracking-widest text-c-text-muted">Profit History</p>
  <p
    class={twMerge(
